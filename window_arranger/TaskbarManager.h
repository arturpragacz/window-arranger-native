...
public:
	...
	Arrangement getArrangement(const std::set<WindowHandle>& handleSet, bool inObserved = true);
...
private:
	Arrangement getArrangement(bool all, const std::set<WindowHandle>* handleSetPtr, bool inObserved = true);
};
